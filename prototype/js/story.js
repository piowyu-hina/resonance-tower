...
export const DIALOGUE_DEFS = {
  ...
  chapter1_defeat: [
    ...
    { speaker: 'narrator', text: '遺跡之主的攻擊敲碎了璃雪胸前的傳送石。', effect: 'teleportStoneBreak' },
    { speaker: 'narrator', text: '碎片間迸出白光。璃雪眼前，遺跡之主的輪廓逐漸模糊。' },
    { speaker: 'narrator', text: '璃雪再也看不見眼前的巨影。光芒散去時，她已從遺跡中消失。' },
  ],
  chapter1_goddess: [
    { speaker: 'narrator', text: '璃雪睜開眼睛。柔和的光映入眼底，耳邊已經聽不見遺跡中的轟鳴。' },
    ...
    { speaker: 'narrator', text: '璃雪低下頭。胸前已經沒有那枚熟悉的墜飾。' },
    ...
    { speaker: 'narrator', text: '璃雪想起最後逼近的攻擊，不自覺縮了縮肩膀。' },
    ...
    { speaker: 'narrator', text: '璃雪低下頭，努力眨了眨眼睛。' },
    ...
    { speaker: 'narrator', text: '女神張開嘴，又停了下來。璃雪等著她繼續。' },
    { speaker: 'goddess', text: '我忘記了。' },
    { speaker: 'wuming', text: '咦……那、那我回去以後怎麼辦？' },
    ...
    { speaker: 'narrator', text: '光芒包圍璃雪。' },
  ],
  chapter1_home_return: [
    { speaker: 'wuming', text: '我、我真的回來了……' },
    { speaker: 'narrator', text: '璃雪低頭看向原本受傷的地方，又慢慢握緊手掌。手指隨著她的心意收攏。' },
    { speaker: 'narrator', text: '她長長吐出一口氣，肩膀終於放鬆下來。' },
    { speaker: 'wuming', text: '對了，《旅人手記》！' },
    { speaker: 'narrator', text: '璃雪翻找了一會兒，從幾本舊書底下抽出一本手記，拂去封面上的灰塵。' },
    { speaker: 'wuming', text: '找到了！' },
  ],
  chapter1_after_book: [
    { speaker: 'narrator', text: '璃雪看著最後一頁，手指停在「我也沒有」那行字旁。' },
    { speaker: 'wuming', text: '他明明救了大家……' },
    { speaker: 'narrator', text: '屋裡很安靜。過了一會兒，璃雪才慢慢翻回記著誓言的那一頁。' },
    { speaker: 'wuming', text: '原來以前真的發生過類似的事情……' },
    { speaker: 'wuming', text: '那些和他一起戰鬥的人，最後也陪著他嗎？' },
    { speaker: 'narrator', text: '書裡沒有答案。璃雪的目光停在兩行誓言上，試著輕聲念了開頭，又停住。' },
    { speaker: 'wuming', text: '不過，這個契約台詞也太害羞了吧……' },
    { speaker: 'wuming', text: '可是，我要去哪裡找那些孩子？' },
    { speaker: 'narrator', text: '璃雪望向窗外，肚子卻在這時叫了一聲。' },
    { speaker: 'wuming', text: '……先去近一點的地方看看，好了。' },
    { speaker: 'wuming', text: '伙食費還沒賺到呢……肚子，你再等我一下。' },
    { speaker: 'narrator', text: '她把手記放回桌上，檢查了一遍劍鞘。走到門邊，又回頭看了一眼熟悉的屋子。' },
  ],
  xiaochu_encounter: [
    {"speaker":"narrator","text":"最後一隻怪物倒下。璃雪還握著劍，等草叢安靜了，才小小地喘了口氣。", wumingBeat: 'idle'},
    {"speaker":"narrator","text":"草叢忽然晃動。一隻史萊姆從裡面跳了出來。", slimeBeat: 'enter'},
    {"speaker":"xiaochu_voice","text":"右邊！牠要跳過去了！"},
    {"speaker":"narrator","text":"璃雪肩膀一縮，腳步卻已先往旁邊錯開。史萊姆擦過她的身側，落在地上。", slimeBeat: 'hop', wumingBeat: 'dodge'},
    {"speaker":"wuming","text":"咦……誰在說話？"},
    {"speaker":"xiaochu_voice","text":"先別看這邊！牠轉過來了！"},
    {"speaker":"narrator","text":"史萊姆縮起身體。", slimeBeat: 'crouch'},
    {"speaker":"xiaochu_voice","text":"就是現在，揮劍！"},
    {"speaker":"narrator","text":"璃雪慌忙照著聲音揮劍。劍尖還沒落下，史萊姆便彈起，撞進她的懷裡。", slimeBeat: 'hit', wumingBeat: 'hit'},
    {"speaker":"wuming","text":"嗚哇！"},
    {"speaker":"narrator","text":"璃雪跌坐在地。史萊姆落下後，再次朝她跳來。", slimeBeat: 'hop'},
    {"speaker":"narrator","text":"璃雪含著眼淚往旁邊一縮，劍卻沒有亂揮。她盯著那團彈起的影子，等牠落地，才短短地刺出一劍。", slimeBeat: 'defeat', wumingBeat: 'strike'},
    {"speaker":"narrator","text":"四周安靜下來。璃雪把劍抱近了些，這才發現自己的手還在抖。", slimeBeat: 'gone'},
    {"speaker":"wuming","text":"剛、剛才……有人在嗎？"},
    {"speaker":"xiaochu_voice","text":"……"},
    {"speaker":"wuming","text":"我聽見妳了……可以出來嗎？"},
    {"speaker":"xiaochu_voice","text":"你聽得到？"},
    {"speaker":"narrator","text":"璃雪轉過頭。一名披著紅色斗篷的金髮少女站在樹旁，睜大眼睛望著她。"},
    {"speaker":"wuming","text":"嗯……剛才嚇了我一跳。"},
    {"speaker":"xiaochu_unknown","text":"不是，我是說……"},
    {"speaker":"narrator","text":"少女往前走了兩步。"},
    {"speaker":"xiaochu_unknown","text":"你真的聽得到我？"},
    {"speaker":"wuming","text":"聽、聽得到。妳別靠這麼快……"},
    ...
    {"speaker":"narrator","text":"她低頭看見璃雪仍坐在地上。"},
    {"speaker":"xiaochu_unknown","text":"啊……你還好嗎？"},
    {"speaker":"wuming","text":"有、有一點痛……我坐一下就好。"},
    {"speaker":"xiaochu_unknown","text":"對不起。"},
    {"speaker":"wuming","text":"我以為……照妳說的做就來得及了。"},
    {"speaker":"xiaochu_unknown","text":"我以為來得及……"},
    {"speaker":"wuming","text":"牠剛才縮起來……我覺得還會跳。可是妳一喊，我就跟著揮了。"},
    ...
    {"speaker":"narrator","text":"璃雪看著她，想起女神說過的那些孩子。"},
    ...
    {"speaker":"narrator","text":"璃雪看了看幽暗的林間，又看向少女，慢慢把劍收好。"},
    {"speaker":"wuming","text":"那……一起走，好嗎？我一個人也有點怕。"},
    {"speaker":"xiaochu_unknown","text":"真的？"},
    {"speaker":"wuming","text":"嗯。不過，揮劍的時候……讓我自己試試看。妳幫我留意旁邊，好不好？"},
    {"speaker":"xiaochu_unknown","text":"……知道了。"},
    {"speaker":"narrator","text":"兩人走了幾步，少女忽然追到她身旁。"},
    {"speaker":"xiaochu","text":"對了，我叫小初！"},
    {"speaker":"wuming","text":"我叫璃雪。"},
    {"speaker":"xiaochu","text":"璃雪……"},
    {"speaker":"xiaochu","text":"剛才撞到的地方，真的沒事嗎？"},
    {"speaker":"wuming","text":"還有一點點……妳可以陪我走慢一點嗎？"},
    {"speaker":"xiaochu","text":"可以啊！這次我會好好看路。"},
  ],
};
