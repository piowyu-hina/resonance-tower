...
export const DIALOGUE_DEFS = {
  ...
  chapter1_after_book: [
    ...
    { speaker: 'narrator', text: '她把手記放在桌上，拿起出門用的劍。' },
  ],
  xiaochu_encounter: [
    {"speaker":"narrator","text":"璃雪清掉眼前最後一隻怪物，放下劍，喘了口氣。", wumingBeat: 'idle'},
    {"speaker":"narrator","text":"草叢忽然晃動。一隻史萊姆從裡面跳了出來。", slimeBeat: 'enter'},
    {"speaker":"xiaochu_voice","text":"右邊！牠要跳過去了！"},
    {"speaker":"narrator","text":"璃雪下意識往旁邊閃。史萊姆擦過她的身側，落在地上。", slimeBeat: 'hop', wumingBeat: 'dodge'},
    ...
    {"speaker":"narrator","text":"璃雪揮下劍。史萊姆卻突然彈起，撞進她的懷裡。", slimeBeat: 'hit', wumingBeat: 'hit'},
    {"speaker":"wuming","text":"嗚哇！"},
    {"speaker":"narrator","text":"璃雪跌坐在地。史萊姆落下後，再次朝她跳來。", slimeBeat: 'hop'},
    {"speaker":"narrator","text":"這次璃雪沒有急著揮劍。她側身躲過撞擊，趁史萊姆落地時補上一劍。", slimeBeat: 'defeat', wumingBeat: 'strike'},
