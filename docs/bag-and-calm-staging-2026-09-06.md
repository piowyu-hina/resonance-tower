...
- 接縫根因已重現：1366×768 縮放下，sticky 標題背景原本只覆蓋中段，兩端留有 32px 面板 padding；金框下一排像素兩端 RGB(69,55,38)、中段(52,40,30)。標題改為滿內框寬背景、以內距保留內容位置後，同排左右均為(57,45,33)。保留金邊、圓角與原位置分隔線，不改成透明外框。
